# testing different learners, (svm, nn, trees, mlp), log loss
...
if __name__ == "__main__":
    ...
    y_pred = pipe.predict_proba(X_test) # the soft predictions, find out what it returns
    # print(y_pred)
    # predicted_y = mlp.predict(X_test)  # sets the predicted data from our training set

    print(log_loss(y_test, y_pred, labels=y_test))
